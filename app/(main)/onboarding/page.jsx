...
import { GrayTitle, PurpleTitle, SectionLabel } from '@/components/reusables';
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="font-serif text-5xl leading-tight tracking-tighter mt-1">
            ...
            <br />
            <PurpleTitle>using Prept?</PurpleTitle>
          </h1>
          ...
          <div className="grid grid-cols-2 gap-4 w-full">
            {ONBOARDING_ROLES.map((r) => (
              <button
                ...
                className="text-left rounded-2xl p-8 border border-white/10 bg-[#0f0f11] hover:border-purple-400/40 hover:-translate-y-0.5 transition-all duration-300"
              >
                <span className="w-11 h-11 rounded-xl bg-purple-400/30 border border-purple-400/40 flex items-center justify-center text-xl mb-5">
                  {r.icon}
                </span>
        ...
        {role && (
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center justify-between bg-[#0f0f11] border border-white/10 rounded-2xl px-6 py-4">
              ...
              <Button variant="purple" size="sm" onClick={() => setRole(null)}>
                Change
              </Button>
            </div>
