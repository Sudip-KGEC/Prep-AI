      ...
      <CardContent className="flex flex-col gap-5">
        ...
        <div className="flex items-center justify-between gap-3">
          <div className="flex flex-col gap-1">
            <p className="text-lg font-serif leading-none bg-linear-to-br from-purple-300 to-purple-500 bg-clip-text text-transparent">
              {creditRate ?? 10}
          ...
          <Button
            variant="outline"
            size="sm"
            className="shrink-0 border-purple-400/20 text-purple-400 hover:bg-purple-400/10 hover:border-purple-400/40"
            asChild
          >
