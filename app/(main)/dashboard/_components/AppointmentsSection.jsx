...
export default function AppointmentsSection({ appointments }) {
  ...
  return (
    <section className="flex flex-col gap-6">
      <div className="bg-[#0f0f11] border border-purple-500/10 rounded-2xl p-8 shadow-[0_0_40px_rgba(168,85,247,0.06)]">
        <span className="w-10 h-10 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center mb-4">
      ...
      {appointments.length === 0 ? (
        <div className="bg-[#0f0f11] border border-purple-500/10 rounded-2xl py-20 text-center shadow-[0_0_40px_rgba(168,85,247,0.04)]">
