...
import { getInterviewerProfile } from "@/actions/bookingSlots";
import { Avatar, AvatarImage, AvatarFallback } from "@/components/ui/avatar";
import { Badge } from "@/components/ui/badge";
import { GrayTitle, SectionLabel } from "@/components/reusables";
import SlotPicker from "./_components/SlotPicker";
import { StarsBackgroundDemo } from "@/components/landingPage-sections/demo-components-backgrounds-stars";
        ...
        <div className="relative max-w-6xl mx-auto px-8 pt-20 pb-14 flex flex-col gap-8">
          ...
          <div className="flex items-start gap-8">
            <Avatar className="w-24 h-24 border-2 border-white/10 shrink-0 rounded-2xl">
              ...
              />
              <AvatarFallback className="rounded-2xl bg-purple-400/10 border border-purple-400/20 text-purple-500 text-3xl font-medium">
                {interviewer.name?.[0] ?? "?"}
              </AvatarFallback>
            </Avatar>
